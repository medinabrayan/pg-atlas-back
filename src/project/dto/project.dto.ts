...
export class ProjectDto {
  ...
  @ApiProperty({ example: 'A blockchain-based carbon insetting platform for low multimodal transport' })
  description: string;
  ...
  @ApiProperty({ example: ['http://data.blockchainforgood.fr/wp-content/uploads/2024/06/algorand_400.png'] })
  blockchainImages: string[];

  @ApiProperty({ example: 'Active' })
  activityStatus: string;

  @ApiProperty({ example: 'https://report.blockchainforgood.fr/wp-content/uploads/2024/03/Sustainable_Development_Goal_13Climate.svg' })
  sdgGoal7: string;
